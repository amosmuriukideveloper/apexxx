<x-filament-panels::page>
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Payment for Project #{{ $record->project_number }}</h2>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    ...
                    <p class="font-semibold text-gray-900 dark:text-white">{{ $record->subject ?? $record->subject_area }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Deadline</p>
                    <p class="font-semibold text-gray-900 dark:text-white">{{ $record->deadline->format('M d, Y H:i') }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Word Count</p>
                    <p class="font-semibold text-gray-900 dark:text-white">{{ number_format($record->word_count ?? $record->page_count * 250) }} words</p>
                </div>
            </div>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                <div class="space-y-2">
                    <div class="flex justify-between">
                        ...
                        <span class="text-gray-900 dark:text-white">${{ number_format($record->budget, 2) }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600 dark:text-gray-400">Difficulty Level</span>
                        <span class="text-gray-900 dark:text-white">{{ ucfirst($record->difficulty_level) }}</span>
                    </div>
                    <div class="border-t border-gray-300 dark:border-gray-600 pt-2 mt-2 flex justify-between">
                        ...
                        <span class="text-2xl font-bold text-green-600 dark:text-green-400">${{ number_format($record->budget, 2) }}</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div>
                    ...
                    <button type="button" 
                        ...
                        <span wire:loading.remove wire:target="processMpesaPayment">
                            💳 Pay ${{ number_format($record->budget, 2) }} via M-Pesa
                        </span>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6 bg-blue-50 dark:bg-blue-900/10 p-6 rounded-lg text-center">
                ...
                <button type="button" 
                    ...
                    <span wire:loading.remove wire:target="processPayPalPayment">
                        🚀 Continue to PayPal (${{ number_format($record->budget, 2) }})
                    </span>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6 bg-purple-50 dark:bg-purple-900/10 p-6 rounded-lg text-center">
                ...
                <button type="button" 
                    ...
                    <span wire:loading.remove wire:target="processPesapalPayment">
                        🚀 Continue to Pesapal (${{ number_format($record->budget, 2) }})
                    </span>
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h4 class="font-semibold text-blue-900 dark:text-blue-100 mb-1">Secure Payment</h4>
