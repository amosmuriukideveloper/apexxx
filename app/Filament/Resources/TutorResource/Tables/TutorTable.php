...
namespace App\Filament\Resources\TutorResource\Tables;
    ...
    public static function getColumns(): array
    {
        return [
            ...
            Tables\Columns\TextColumn::make('subjects')
                ...
                ->limit(3)
                ->color('primary')
                ->tooltip(fn ($record) => implode(', ', $record->subjects ?? [])),
    ...
    public static function getActions(): array
    {
        return [
            ...
            Tables\Actions\Action::make('approve')
                ...
                ->visible(fn (Tutor $record) => $record->application_status === 'pending')
                ->action(function (Tutor $record) {
                    ...
                    Notification::make()
                        ...
                        ->body("Tutor {$record->name} has been successfully approved.")
                        ->send();
                }),
            Tables\Actions\Action::make('reject')
                ...
                ->action(function (Tutor $record, array $data) {
                    ...
                    Notification::make()
                        ...
                        ->body("Tutor {$record->name} application has been rejected.")
                        ->send();
                }),
            Tables\Actions\Action::make('suspend')
                ...
                ->color('warning')
                ->requiresConfirmation()
                ->visible(fn (Tutor $record) => $record->status === 'active')
                ->action(function (Tutor $record) {
            ...
            Tables\Actions\Action::make('activate')
                ...
                ->color('success')
                ->requiresConfirmation()
                ->visible(fn (Tutor $record) => $record->status === 'suspended')
                ->action(function (Tutor $record) {
