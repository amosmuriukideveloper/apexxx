...
class SubmissionsRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'My Submissions';
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\DeleteAction::make()
                    ->visible(fn ($record) => $record->admin_review_status === 'pending'),
            ])
            ->defaultSort('version_number', 'desc')
            ->emptyStateHeading('No submissions yet')
            ->emptyStateDescription('Upload your first submission when you\'re ready.')
